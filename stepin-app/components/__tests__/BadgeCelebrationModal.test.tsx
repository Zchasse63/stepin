...
jest.mock('../ConfettiCelebration', () => ({ ConfettiCelebration: 'ConfettiCelebration' }));
...
describe('BadgeCelebrationModal', () => {
  ...
  const mockBadge = {
    id: 'badge-1',
    name: 'First Steps',
    description: 'Logged your first walk',
    icon: 'footsteps',
  ...
  it('should render when visible with badge', () => {
    const { getByTestId } = render(
      <BadgeCelebrationModal visible={true} onDismiss={jest.fn()} badge={mockBadge} />
    );
  ...
  it('should not render when not visible', () => {
    const { queryByTestId } = render(
      <BadgeCelebrationModal visible={false} onDismiss={jest.fn()} badge={mockBadge} />
    );
